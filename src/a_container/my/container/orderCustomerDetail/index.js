    ...
    switch (String(item.activityStatus)) {
      ...
      case "5":
        return {
          ...
          info: (
            <span>
              退款审核未通过，如有疑问，请联系客服：<a href="tel:4001519999">
                4001519999
              </a>
            </span>
          ),
    ...
    return (
      <div className="page-order-detail">
        ...
        {type !== 5 && addr ? (
          <List>
            ...
            >
              ...
              <Brief>
                <div>
                  电话：<a href={`tel:${addr.mobile || ""}`}>
                    {addr.mobile || ""}
                  </a>
                </div>
                <div className="all_warp">
                  收货地址：{`${addr.province || ""}${addr.city ||
        ...
        <div className="order-info">
          ...
          <div className="basic">
            <div>
              下单人信息：{this.props.orderInfo.userInfo &&
                this.props.orderInfo.userInfo.realName}
            </div>
            <div>
              昵称：{this.props.orderInfo.userInfo &&
                this.props.orderInfo.userInfo.nickName}
            </div>
            <div>
              e家号：{this.props.orderInfo.userInfo &&
