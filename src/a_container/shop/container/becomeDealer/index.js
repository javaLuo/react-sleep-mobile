    ...
    return (
      <div className="flex-auto page-box become-dealer">
          ...
          <div className="thefooter page-flex-row">
              <div className="flex-none" style={{ textAlign: 'center', width: '100%' }} onClick={() => this.onSubmit()}>下一步</div>
          </div>
      </div>
    );
  }
